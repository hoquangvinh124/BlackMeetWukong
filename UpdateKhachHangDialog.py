...
class UpdateKhachHangDialog(QDialog):
    ...
    def __init__(self, row_index, row_data):
        ...
        self.customer_info = self.select_customer()[0]

        self.customer_name_info = self.customer_info[0]
        self.customer_id_info = self.customer_info[1]
        self.customer_gender_info = self.customer_info[2]
        self.customer_model_info = self.customer_info[3]
        self.customer_birthday_info = self.customer_info[4]
        self.customer_age_info = self.customer_info[5]
        self.customer_address_info = self.customer_info[6]
        self.customer_phone_info = self.customer_info[7]
        self.customer_email_info = self.customer_info[8]
...
"}")
    ...
    def retranslateUi(self):
        ...
        self.update_nm_comboBox.setItemText(0, _translate("UpdateKhachHangDialog", "Model 1"))
        self.update_nm_comboBox.setItemText(1, _translate("UpdateKhachHangDialog", "Model 2"))
        self.update_nm_comboBox.setItemText(2, _translate("UpdateKhachHangDialog", "Model 3"))
        self.update_nm_comboBox.setItemText(3, _translate("UpdateKhachHangDialog", "Model 4"))
        self.update_nm_comboBox.setItemText(4, _translate("UpdateKhachHangDialog", "Model 5"))
        self.update_nm_comboBox.setItemText(5, _translate("UpdateKhachHangDialog", "Model 6"))
        self.update_nm_comboBox.setItemText(6, _translate("UpdateKhachHangDialog", "Model 7"))
        self.update_nm_comboBox.setItemText(7, _translate("UpdateKhachHangDialog", "Model 8"))
        self.update_nm_comboBox.setItemText(8, _translate("UpdateKhachHangDialog", "Model 9"))
        self.update_nm_comboBox.setItemText(9, _translate("UpdateKhachHangDialog", "Model 10"))
    ...
    # RetranlateUi
        ...
        self.update_gender_comboBox.setCurrentText(str(self.customer_gender_info))
        self.update_nm_comboBox.setCurrentText(str(self.customer_model_info))
        self.update_dob_dateEdit.setDate(date_object)
        self.update_address_lineEdit.setText(str(self.customer_address_info))
    ...
    def select_customer(self):
            ...
            select_query=f"SELECT * FROM customer_table WHERE names=%s AND customer_id=%s"
    ...
    def update_data(self):
            ...
            try:
                ...
                update_query=f'UPDATE customer_table SET names=%s, customer_id=%s, gender=%s, nails=%s, birthday=%s, age=%s, address=%s, phone_number=%s, email=%s WHERE customer_id=%s'
    ...
    def on_gender_changed(self, index):
            ...
            if index !=self.lastIndex:
                    ...
                    new_customer_id=self.generate_customerId(gender_item)

                    return new_customer_id
            else:
                    return self.customer_id_info
