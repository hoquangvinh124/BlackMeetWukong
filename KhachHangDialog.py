...
"}")
    ...
    def reset_font_to_default(self):
            ...
            self.email_lineEdit.setFont(default_font)
    ...
    def retranslateUi(self, KhachHangDialog):
        ...
        self.nm_comboBox.setItemText(0, _translate("KhachHangDialog", "Model 1"))
        self.nm_comboBox.setItemText(1, _translate("KhachHangDialog", "Model 2"))
        self.nm_comboBox.setItemText(2, _translate("KhachHangDialog", "Model 3"))
        self.nm_comboBox.setItemText(3, _translate("KhachHangDialog", "Model 4"))
        self.nm_comboBox.setItemText(4, _translate("KhachHangDialog", "Model 5"))
        self.nm_comboBox.setItemText(5, _translate("KhachHangDialog", "Model 6"))
        self.nm_comboBox.setItemText(6, _translate("KhachHangDialog", "Model 7"))
        self.nm_comboBox.setItemText(7, _translate("KhachHangDialog", "Model 8"))
        self.nm_comboBox.setItemText(8, _translate("KhachHangDialog", "Model 9"))
        self.nm_comboBox.setItemText(9, _translate("KhachHangDialog", "Model 10"))
